...
export declare function initWithThreads(n: number): void;
 ...
 */
export declare function setupTelemetryAnalytics(): boolean;
 ...
 * package (T15e). */
export { Cognee, type CogneeConfigObject, type CogneeDatasetObject, type CogneeSessionObject, type CogneeNotebookObject, type CogneeUserObject, } from "./cognee";
