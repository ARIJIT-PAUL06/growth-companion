...
export type SearchTypeString = "SUMMARIES" | "CHUNKS" | "RAG_COMPLETION" | "TRIPLET_COMPLETION" | "GRAPH_COMPLETION" | "GRAPH_SUMMARY_COMPLETION" | "CYPHER" | "NATURAL_LANGUAGE" | "GRAPH_COMPLETION_COT" | "GRAPH_COMPLETION_CONTEXT_EXTENSION" | "FEELING_LUCKY" | "FEEDBACK" | "TEMPORAL" | "CODING_RULES" | "CHUNKS_LEXICAL";
/** Recall scope wire names (snake_case; "all" expands to all four concrete scopes). */
export type RecallScopeString = "auto" | "graph" | "session" | "trace" | "graph_context" | "all";
